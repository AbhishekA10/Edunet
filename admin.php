...
<br/>
  ...
  <br/>
  <br/>
  <font size="4"><a href="admin_logout.php">Logout</a></font>
    <br/>
	<br/>
</div>
<br/>
...
<?php
$con=mysqli_connect("localhost","root","","edunet");
...
while($row=mysqli_fetch_array($sql))
{
	...
	<td style="border:1px solid #000;"><?php echo $row['mobile']; ?></td>
	<td style="border:1px solid #000;"><?php echo $row['message']; ?></td>
	<td style="border:1px solid #000;">
	<a href="edit.php?e=<?php echo $row['id']; ?>" class="btn btn-success">Update</a>
	<a href="delete.php?d=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
	</td>
	</tr>
	</tbody>
	<?php
